...
class Grid4 {
  ...
  double derij(int pointIndex, int dir1, int dir2, Quaternion const& pos = {-1., -1., -1., -1.}) const;
  ...
  double derij(int pointIndex, int dir1, int dir2, Function const& f, Quaternion const& pos = {-1., -1., -1., -1.}) const;
};
